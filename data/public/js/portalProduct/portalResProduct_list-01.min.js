$define(["wgt_util", "wgt_readyload", "jquery.adFocus", "jquery.mediaQuery", "md5", "jquery.confirm", "jquery.message", "jquery.fileDownload"], function(e, f, o, t, r, a, n, s, i) {
    var g = function(e, t, r, a, n, o) {
            var s = {};
            s.request_url = r, s.url_param = a, s.requst_type = n, "true" == t.isMock && (s.url_param.isMock = "true");
            var i = encodeURIComponent(encodeURIComponent(JSON.stringify(s))),
                u = f.md5Sign(JSON.stringify(s));
            f.ajax({
                type: "POST",
        ...
        u = function(e, t) {
            var r, a, n, o = t.defaultImage,
                s = t.definedDefaultImage;
            r = e, n = o, 1 == (a = s) || "true" == a ? f(".p_images img", r).onErrorImg(n) : f(".p_images img", r).onErrorImg();
            var i = 2;
    ...
    function l(e, t) {
        if (! function n(e) {
            ...
            $compCl.getAllInitFunc()[e].add(a), o.lazyImg()
        }
    }
    ...
    function y(n) {
        ...
        return o.specId = undefined, o.minBuyNum = 1, f.each(n.skus, function(e, t) {
            if (t.productSkuSpecs && (o.specId = "2", o.minBuyNum = t.moq || 1), "1" == t.isDefault) {
                o.skuId = t.id, o.skuName = t.name;
                for (var r = 0; r < t.productSkuSpecs.length; r++)
                    if (r == t.productSkuSpecs.length - 1 ? o.skuSpec += t.productSkuSpecs[r].specName + ":" + t.productSkuSpecs[r].specValueName : o.skuSpec += t.productSkuSpecs[r].specName + ":" + t.productSkuSpecs[r].specValueName + " ", "" == o.skuImg)
                        for (var a = 0; a < n.specConfs.length; a++) n.specConfs[a].id == t.productSkuSpecs[r].specConfigId && n.specConfs[a].productSpecImgList && 0 < n.specConfs[a].productSpecImgList.length && "" == o.skuImg && (o.skuImg = n.specConfs[a].productSpecImgList[0].imagePath);
                return !1
            }
        }), o
    }
    ...
    function P(c, t) {
        t.find(".p_addCart").unbind("click").click(function() {
            ...
            ! function l(e, t, r) {
                var a, n = r.attr("id"),
                    o = r.attr("price"),
                    s = JSON.parse(r.attr("skuSpec")),
                    i = e.errtips,
                    u = {},
                    c = (u = y(s)).skuId;
                a = u.minBuyNum ? u.minBuyNum : 1, u.skuImg || (u.skuImg = r.attr("image"));
                var d = {};
                d[c] = {
                    skuId: c,
                    productId: n,
            ...
            var a = f.trim(f(this).siblings(".js_compareFloatData").attr("price")),
                n = JSON.parse(f(this).siblings(".js_compareFloatData").attr("skuSpec")),
                o = y(n).skuId,
                s = y(n).minBuyNum,
                i = [];
            i[0] = {
                ...
                }(0, r + "?buyInfo=" + encodeURIComponent(JSON.stringify(i)), t)
    ...
    function h(e, t, r, a, n) {
        ...
        g(a, n, "/contentApi/files/findFilesUrlList", {
            formData: JSON.stringify(o)
        }, "POST", function s(e) {
            try {
                var e = JSON.parse(e.data).data;
                if (0 == e.isLogin) window.location.href = location.origin + "/" + e.loginUrl + "?goToUrl=" + location.pathname;
                else if (2 == e.isLogin) {
                    var t;
                    t = 0 == window.tenant.foreign || "zh_CN" == window.tenant.language ? "对不起，您无权限做此操作！" : "Sorry, you do not have permission to do this operation!", f.message({
                        msg: t,
                        type: "error"
                    })
                } else {
                    var r = e.fileUrlList;
                    r && r.length && (navigator.platform.indexOf("Win") ? window.location.href = r[0] : function o(e) {
                        var t = e[0],
                            r = t.substring(t.lastIndexOf(".") + 1);
                        if ("doc" === r || "docx" === r || "pdf" === r || "PDF" === r || "mp4" === r || "MP4" === r || "png" === r || "jpg" === r || "jpeg" === r || "gif" === r || "txt" === r || "xml" === r || "xls" === r || "ppt" === r || "xlsx" === r || "pptx" === r || "zip" === r || "tiff" === r || "mvb" === r || "rmvb" === r || "flv" === r || "rar" === r || "exe" === r || "jar" === r || "gif" === r || "tiff" === r || "RAR" === r || "arj" === r) window.open(t, "_blank");
                        else if (function n() {
                                return !!(window.ActiveXObject || "ActiveXObject" in window)
                            }() || "html" === r) ! function v(e, t, r) {
                            var a, n, o = window,
                                ...
                                m = o.Blob || o.MozBlob || o.WebKitBlob || p,
                                l = t || "download";
                            m = m.call ? m.bind(o) : Blob;
                            "true" === String(this) && (i = (u = [u, i])[0], u = u[1]);
                            if (c && c.length < 2048) {
                                l = c.split("/").pop().split("?")[0], d.href = c;
                                var f = decodeURIComponent(d.href);
                                if (f && -1 !== f.indexOf(c)) {
                                    var g = new XMLHttpRequest;
                                    return g.open("GET", c, !0), g.responseType = "blob", g.onload = function(e) {
                                        v(e.target.response, l, s)
                                    }, setTimeout(function() {
                                        g.send()
                                    }, 0), g
                                }
                            ...
                            if (/^data\:[\w+\-]+\/[\w+\-]+[,;]/.test(u)) {
                                if (!(2096103.424 < u.length && m !== p)) return navigator.msSaveBlob ? navigator.msSaveBlob(y(u), l) : P(u);
                                u = y(u), i = u.type || s
                            }
                            a = u instanceof m ? u : new m([u], {
                                type: i
                            });

                            function y(e) {
                                for (var t = e.split(/[:;,]/), r = t[1], a = "base64" == t[2] ? atob : decodeURIComponent, n = a(t.pop()), o = n.length, s = 0, i = new Uint8Array(o); s < o; ++s) i[s] = n.charCodeAt(s);
                                return new m([i], {
                                    type: r
                                })
                            }
                            ...
                            function P(e, t) {
                                if ("download" in d) return d.href = e, d.setAttribute("download", l), d.className = "download-js-link", d.innerHTML = "downloading...", d.style.display = "none", document.body.appendChild(d), setTimeout(function() {
                                ...
                                document.body.appendChild(r), t || (e = "data:" + e.replace(/^data:([\w\/\-\+]+)/, s)), r.src = e, setTimeout(function() {
                                    document.body.removeChild(r)
                                }, 333)
                            }
                            if (navigator.msSaveBlob) return navigator.msSaveBlob(a, l);
                            if (o.URL) P(o.URL.createObjectURL(a), !0);
                            else {
                                if ("string" == typeof a || a.constructor === p) try {
                                    return P("data:" + i + ";base64," + o.btoa(a))
                                } catch (h) {
                            ...
                            a.style.display = "none", document.body.appendChild(a), a.src = t
                        }
                    }(r))
                }
            } catch (a) {}
    ...
    return {
        init: function() {
                    ...
                    a = {
                        click: function(e, t, r, a) {
                            if ("def" == r.key) {
                                t.attr("lang", "active");
                                var n = t.siblings();
                                f.resetOtherSort(n, a), c.requestParam.orderColumn = r.key, c.requestParam.orderType = "0"
                            } else {
                                f.triggerProductSort(t, r, a);
                                var o = t.data("productCount");
                                c.requestParam.orderColumn = r.key, c.requestParam.orderType = o
                            }
                            var s = "";
                            if (c.requestParam.screenFlag = c.requestParam.screenflag || "false", s = "true" == c.requestParam.screenFlag ? m(c.id) + "&cache=false" : m(c.id), 768 == f.mediaQuery({
                                    node: !0
                                })) {
                                var i = f(".p_pagebox .click", d).attr("currentpage");
                                c.requestParam.currentPage = i;
                                var u = p(s, c.requestParam);
                                d.html(u)
                            } else 7681024 != f.mediaQuery({
                                node: !0
                            }) && 1024 != f.mediaQuery({
                                node: !0
                            }) || (i = f(".pageNum.active", d).html(), c.requestParam.currentPage = i, u = p(s, c.requestParam), d.html(u))
                        }
                    };
                return {
                    item: [{
            ...
            }(t, r)).init(), f("div.p_products").addClass("p_productsSet");
            var e, a;
            t.requestParam.orderType || (t.requestParam.orderType = "0"), t.requestParam.orderColumn || (t.requestParam.orderColumn = "def"), r.find(".js-dropdown").click(function(e) {
                ...
                r.find(".dropdown-menu").hide()
            }), r.find(".js_down").off("click"), r.find(".js_down").on("click", function(e) {
                e.stopPropagation(), h(f(this).attr("data-fileId"), t.appId, f(this).attr("data-comId"), r, t)
                ...
                f(".p_OccupyBox .p_page").hide(), 0 < f(".p_OccupyBox .p_pagebox").length ? f(".p_OccupyBox .p_pagebox").show() : ("turnPage" == t.pageParam.turnPageType && f(".p_products", r).removeAttr("isServerPaging"), function s(e, t) {
                    ...
                    if (t.requestParam.screenflag != undefined && t.requestParam.screenItemStr != undefined && t.requestParam.screenGroupId != undefined) {
                        ...
                        var n = f.getUrlId();
                        if (n && !isNaN(n)) a.data.productCateId = n;
                        else {
                            var o = c("productCateId");
                            o && !isNaN(o) && (a.data.productCateId = n)
                        }
                    }
                ...
                d(t, r), f(".p_OccupyBox .p_pagebox").hide(), 0 < f(".p_OccupyBox .p_page").length && f(".p_OccupyBox .p_page").show(), "turnPage" == t.pageParam.turnPageType && f(".p_products", r).removeAttr("isServerPaging"),
                    function s(e, t) {
                        var r = t.pageParam.url + "&orderType=" + t.requestParam.orderType + "&orderColumn=" + t.requestParam.orderColumn + "&" + t.requestParam.appType + "=" + t.requestParam.productCateId,
                            a = {
                                url: "true" == t.requestParam.screenflag ? r + "&cache=false" : r,
                        ...
                        if (t.requestParam.screenflag != undefined && t.requestParam.screenItemStr != undefined && t.requestParam.screenGroupId != undefined) {
                            ...
                            var n = f.getUrlId();
                            if (n && !isNaN(n)) a.requestParam.productCateId = n;
                            else {
                                var o = c("productCateId");
                                o && !isNaN(o) && (a.requestParam.productCateId = o)
                            }
                        }
            ...
            }(), u(r, t.picParams), P(t, r), e = r, (a = t.textParams).isCutOfName && f(".d_title", e).fixLineN(a.linesOfCutOfName), a.isCutOfSummary && f(".d_summary", e).fixLineN(a.linesOfCutOfSummary), a.categorySummary && f(".p_categorySummary", e).fixLineN(a.categorySummaryMaxLen)
        }
    }
});