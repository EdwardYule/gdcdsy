...
function getStaticHost() {
    ...
    var fullHostname = port ? t + ":" + port : t;
    return null == window.tenant ? fullHostname : sendLevel.test(t) || "1" != tenant.cdnFlag ? fullHostname : t.startsWith("www.") ? t.replace("www.", e) + (port ? ":" + port : "") : e + t + (port ? ":" + port : "");
}
...
require.config({
    ...
    paths: {
        ...
        afterLoad: "public/wgt/coreLibs/afterLoad",
    ...
    function(e, t) {
        ...
        var f = function(n) {
            ...
            for (e in m = ie.support = {}, i = ie.isXML = function(e) {
                    ...
                    return l !== C && 9 === l.nodeType && l.documentElement ? (r = (C = l).documentElement, b = !i(l), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
                        ...
                        e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && T.push("[*^$]=" + M + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || T.push("\\[" + M + "*(?:value|" + L + ")"), e.querySelectorAll(":checked").length || T.push(":checked")
                    }), ae(function(e) {
                    ...
                    if ((e.ownerDocument || e) !== C && y(e), t = t.replace(X, "='$1']"), m.matchesSelector && b && (!a || !a.test(t)) && (!T || !T.test(t))) try {
                        var n = s.call(e, t);
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(e) {
                            var t, n = !e[6] && e[2];
                            return J.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && U.test(n) && (t = g(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function(e) {
                ...
                return v && !v[_] && (v = ye(v)), y && !y[_] && (y = ye(y, e)), oe(function(e, t, n, i) {
                    ...
                    if (e) {
                        if (y || h) {
                            ...
                            for (o = f.length; o--;)(a = f[o]) && -1 < (r = y ? O.call(e, a) : s[o]) && (e[r] = !(t[r] = a))
                        }
            ...
            return pe.prototype = w.filters = w.pseudos, w.setFilters = new pe, g = ie.tokenize = function(e, t) {
                ...
                if (n = n || [], 1 === c.length) {
                    ...
                    for (r = J.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !w.relative[s = a.type]);)
        ...
        _.event = {
            ...
            trigger: function(e, t, n, i) {
                ...
                if (a = u = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !V.test(f + _.event.triggered) && (0 <= f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), o = f.indexOf(":") < 0 && "on" + f, (e = e[_.expando] ? e : new _.Event(f, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = undefined, e.target || (e.target = n), t = null == t ? [e] : _.makeArray(t, [e]), l = _.event.special[f] || {}, i || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                    if (!i && !l.noBubble && !_.isWindow(n)) {
                        for (s = l.delegateType || f, V.test(s + f) || (a = a.parentNode); a; a = a.parentNode) d.push(a), u = a;
            ...
            fix: function(e) {
                ...
                var t, n, i, r = e.type,
                    o = e,
                    a = this.fixHooks[r];
                for (a || (this.fixHooks[r] = a = J.test(r) ? this.mouseHooks : G.test(r) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new _.Event(o), t = i.length; t--;) e[n = i[t]] = o[n];
            ...
            setup: function() {
                if (U.test(this.nodeName)) return "checkbox" !== this.type && "radio" !== this.type || (_.event.add(this, "propertychange._change", function(e) {
        ...
        _.extend({
            ...
            set: function(e, t) {
                ...
                ((n.zoom = 1) <= t || "" === t) && "" === _.trim(o.replace(Oe, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || i && !i.filter) || (n.filter = Oe.test(o) ? o.replace(Oe, r) : o + " " + r)
            }
            ...
            run: function(e) {
                ...
                return this.options.duration ? this.pos = t = _.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Je.propHooks._default.set(this), this
            }
        ...
        function ct(o, e, t) {
            var n, a, i = 0,
                ...
                l = function() {
                    if (a) return !1;
                    for (var e = Ve || st(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), i = 0, r = u.tweens.length; i < r; i++) u.tweens[i].run(n);
                ...
                send: function(e, o) {
                    ...
                    a.send(l.hasContent && l.data || null), u = function(e, t) {
                        ...
                        if (u && (t || 4 === a.readyState))
                            if (delete Xt[s], u = undefined, a.onreadystatechange = _.noop, t) 4 !== a.readyState && a.abort();
                            else {
        ...
        _.ajaxSetup({
            ...
            if (a || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = _.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Vt, "$1" + i) : !1 !== e.jsonp && (e.url += (Ct.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
                return o || _.error(i + " was not called"), o[0]
            }, e.dataTypes[0] = "json", r = m[i], m[i] = function() {
                o = arguments
            }, n.always(function() {
                m[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, Jt.push(i)), o && _.isFunction(r) && r(o[0]), o = r = undefined
            }), "script"
...
function createXinNetAD() {
    ...
    t.find(".js_close").on("click", function(e) {
        ...
        e.stopPropagation(), window.open("https://www.ceurl.cn/qHSmnP1", "_blank")
    })
}
...
function openNoPerDialog() {
    ...
    if (t.setAttribute("type", "text/javascript"), t.setAttribute("src", "/upload/response.js"), document.body.appendChild(t), t.onload = function() {
        ...
        var i = $("body").attr("data-pageid"),
            ...
            o = r.substring(0, 2);
        if ("zh" == o && (o = "zh-cn" == r || "zh_cn" == r ? "zh_CN" : "zh_HN"), 0 <= window.location.href.indexOf("isHandleSwitch") && sessionStorage.setItem("noJump", !0), "true" === sessionStorage.getItem("noJump") || !0 === sessionStorage.getItem("noJump")) return;
        if (window.tenant.language == o) return;
        var a = {};
        "string" == typeof window.getMultilingual && /^{/.test(window.getMultilingual) ? a = JSON.parse(window.getMultilingual) : "object" == typeof window.getMultilingual && (a = window.getMultilingual), a && "on" == a.switcher && (getParentWindow().VisualManager || sendLevel.test(window.location.hostname) || $.ajax({
