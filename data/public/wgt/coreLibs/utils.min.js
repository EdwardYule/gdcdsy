            ...
            var t = /^(?!http(s)?:\/\/)(.*?)\/(.*?\.(png|jpg|gif|jpeg|webp|bmp|tiff|PNG|JPG|GIF|JPEG|WEBP|BMP|TIFF))$/,
                ...
                s = function(e, s) {
                    return "" == s || t.test(e) && (e = e.replace(t, function(e, t, i) {
                        return e.startsWith("/") || (e = "/" + e), s + e
                    })), e
                };
            if ("string" == typeof e) t.test(e) && "" != (n = i(tenant.cdnFlag, tenant.unittype)) && (e = s(e, n));
            else
                for (var a in e) {
                    var n;
                    if (t.test(e[a])) "" != (n = i(tenant.cdnFlag, tenant.unittype)) && (e[a] = s(e[a], n))
                }
            return e
        }, $
    });